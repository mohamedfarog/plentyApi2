...
class ApplePass extends Model
{
    ...
    public static function createLoyaltyPass(User $user)
    {
        ...
        $pass_definition = [
            ...
            "barcode" => [
                "message"   => trim('{"customer_name":"' . $user->name . '","customer_mobile_number":"' . substr($user->contact, 4) . '","mobile_country_code":' . intval(substr($user->contact, 1, 3)) . ',"reward_code":"' . $pass_identifier . '"}'),
