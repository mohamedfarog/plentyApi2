...
<p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 21px; margin: 0;">ID: {{explode('.',$data->user->loyaltyidentifier)[0]}}</p>
