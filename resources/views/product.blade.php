...
<div class="heading-banner-area overlay-bg"
    style="margin: 0 5%;background: rgba(0, 0, 0, 0) url('img/product/Banner.png') no-repeat scroll center center / cover;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="product-info mt-50" style="padding:0 15px">
                        <div class="fix">
                            <h4 class="post-title floatleft"
                                style="font-size:24px;font-weight:bolder;line-height:200%;font-family:'Avenir bold';color:black;">
                                HOT CHOCO</h4>
                        ...
                        <!-- color end -->
                        <!-- Size start -->
                        <span class="color-title text-capitalize mb-20"
                            style="font-size:18px;text-transform:uppercase">size</span>
                        ...
                        <div class="clearfix">
                            <div class="cart-plus-minus" style="width:50%;background:#e1e0e5;">
                                ...
                                <input type="text" value="02" name="qtybutton" class="cart-plus-minus-box"
                                    style="background: #e1e0e5 none repeat scroll 0 0;">
